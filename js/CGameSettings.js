function CGameSettings(_iLang, Level) {
    ...
    this._init = function () {
        ...
        _oButDelSomeLetters = new CGfxButton(CANVAS_WIDTH / 2 - 100, CANVAS_HEIGHT / 2 + GAME_ELEMENT_HEIGHT + 940, _oSpriteDSL);
        ...
        _oButAddALetter = new CGfxButton(CANVAS_WIDTH / 2 + 100, CANVAS_HEIGHT / 2 + GAME_ELEMENT_HEIGHT + 940, _oSpriteAAL);
    ...
    this.placeLetters = function () {
        ...
        for (_i = 0; _i < NUM_OF_SPAWN_LETTER; _i++) {
            ...
            if (_i < _iNumber_Of_Char) {
                if (_i % 2 === 0) {
                    _aLetters[_i] = new CTextButton(CANVAS_WIDTH / 2 - (120 * _ik) + 24 * (NUM_OF_SPAWN_LETTER), CANVAS_HEIGHT / 2 + GAME_ELEMENT_HEIGHT + 750, oSprite, _szAnswerWords.charAt(_i), PRIMARY_FONT, "#382074", 66, -10);
                }
                else
                {
                    _aLetters[_i] = new CTextButton(CANVAS_WIDTH / 2 - (120 * _ik) + 24 * (NUM_OF_SPAWN_LETTER), CANVAS_HEIGHT / 2 + GAME_ELEMENT_HEIGHT + 630, oSprite, _szAnswerWords.charAt(_i), PRIMARY_FONT, "#382074", 66, -10);
                    _ik++;
                }
                ...
                if (_i % 2 === 0) {
                    _aLetters[_i] = new CTextButton(CANVAS_WIDTH / 2 - (120 * _ik) + 24 * (NUM_OF_SPAWN_LETTER), CANVAS_HEIGHT / 2 + GAME_ELEMENT_HEIGHT + 750, oSprite, ALPHABET[_iLanguage][_iRandomLetter], PRIMARY_FONT, "#382074", 66, -10);
                }
                else
                {
                    _aLetters[_i] = new CTextButton(CANVAS_WIDTH / 2 - (120 * _ik) + 24 * (NUM_OF_SPAWN_LETTER), CANVAS_HEIGHT / 2 + GAME_ELEMENT_HEIGHT + 630, oSprite, ALPHABET[_iLanguage][_iRandomLetter], PRIMARY_FONT, "#382074", 66, -10);
                    _ik++;
                }
    ...
    this.checkVictory = function () {
        ...
        if (_iOccupied === _iNumber_Of_Char) {
            ...
            else
            {
                ...
                s_oStage.setChildIndex(_oButMistake, s_oStage.getNumChildren() - 1);
    ...
    this.zoomImage = function (iExPosX, iExPosY, fExScale, iID) {
        ...
        _aImgWords[_iLevel][iID].changeChildIndex(s_oStage.getNumChildren() - 5);
        ...
        _aImgCopyright[_iLevel][iID].changeChildIndex(s_oStage.getNumChildren() - 4);
